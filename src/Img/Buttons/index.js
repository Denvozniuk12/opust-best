export const leftButtonIcon = (<svg viewBox="64 64 896 896" focusable="false" data-icon="left-circle" width="1em" height="1em" fill="currentColor" aria-hidden="true" className="swiper-button-svg">
...
export const rightButtonIcon = (<svg viewBox="64 64 896 896" focusable="false" data-icon="right-circle" width="1em" height="1em" fill="currentColor" aria-hidden="true" className="swiper-button-svg">
