...
function Navigation() {
    ...
    const registrationBtnSvg = (
        <svg viewBox="64 64 896 896" focusable="false" data-icon="user-add" width="1em" height="1em" fill="currentColor" aria-hidden="true">
    ...
    return (
        <div className='navigation'>
            ...
            <button className='menu-btn' onClick={handlerClick}>
